...
This project aims to address these issues by providing an intelligent study assistant that automatically generates flashcards and quizzes from existing notes. With these generated study tools it will help students engage with their material more effecitvely, saving time and enhancing learning through interactive, personalized tools.
...
# Requirements
  ...
  3. Quiz Generation:
     ...
     - The user shoudl receive instant feedback on their answers, showing which questions were answered correctly or incorrectly
  4. Study Material Storage:
  ...
  We have 5 features and 12 requirements.
